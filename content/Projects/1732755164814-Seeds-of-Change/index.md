...
I used my existing experience with live service architectures in Unity to create a prototype that would load geolocations and ingame event metadata into the game. We also scraped websites like the [Environmental Voter Scorecard](https://www.lcv.org/congressional-scorecard/) and dynamically pulled live information into the game for easy visualization and use in gameplay. 
